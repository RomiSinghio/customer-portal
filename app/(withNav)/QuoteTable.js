                    ...
                    >
                      ...
                      <td className="px-3 py-4 text-sm text-secondary whitespace-nowrap">
                        <div className="mb-2 text-black">
                          {quote.passanger_name}
                        </div>
                        <div className="text-secondary">
                          {quote.passanger_phone}
                        </div>
                      </td>
                      ...
                      <td className="px-3 py-4 text-sm text-secondary whitespace-nowrap">
                        <div className="mb-2 text-black">{quote.job_date}</div>
                        <div className="text-secondary">{quote.job_time}</div>
                      </td>
                      <td className="px-3 py-4 text-sm text-secondary whitespace-nowrap">
                        <div className="text-black">£{quote.price}</div>
                      </td>
                      <td className="px-3 py-4 text-sm text-secondary whitespace-nowrap">
